...
class SchedulesRun extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($schedules as $schedule) {
            ...
            $start_time = Carbon::createFromFormat('Y-m-d H:i:s', $times[0]->start_time)->format('d F Y');
            ...
            $invoice = $this->invoiceService->store([
                ...
                'number' => generateInvoiceNumber(is_null($previous_invoice) ? '1' : $previous_invoice->number),
                ...
                'seller_company_name' => $organization->company_name,
                ...
                'services' => [
                    [
                        'name' => 'Services during ' . $start_time . ' - ' . now()->format('d F Y'),
            ...
            ])->notify(new ScheduleEmail($this->invoiceService, $invoice, [
