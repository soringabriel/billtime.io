...
class OneMonthInactivity extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject(__('Do You Remember Timo-Track?'))
            ->line(__('I\'m Peter, from Timo-Track.com. We noticed that it\'s been a month since your last login and we would like to see if you\'re still interested in using our service.'))
