...
class TrialCancelationWarning extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line(__('As a new user you received two weeks of trial on https://billtime.io with all of the features of the service. There are still 3 more days, while you benefit from this free trial.'))
            ...
            ->action(__('Check Out Plans'), 'https://billtime.io/plan')
