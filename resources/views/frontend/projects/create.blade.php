                        ...
                        <x-slot name="body">
                            <div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="number" name="price" class="form-control" placeholder="{{ __('Price per hour') }}" step=".01" />
                                    </div>
                                </div><!--form-group-->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="price_currency" class="form-control" placeholder="{{ __('Currency for price') }}" maxlength="3" />
                                    </div>
                                </div><!--form-group-->
                            </div>
                        </x-slot>
