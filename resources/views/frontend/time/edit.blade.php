            ...
            <div class="col-md-12">
                <x-forms.patch :action="route('frontend.time.update', $time)">
                    <x-frontend.card>
                        ...
                        <x-slot name="body">
                            <div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="datetime" class="datetimepicker form-control" name="start_time" placeholder="{{ __('Start Time') }}" value="{{ old('start_time') ?? $time->start_time }}" autocomplete="off" required />
                                    </div>
                                </div><!--form-group-->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="datetime" class="datetimepicker form-control" name="end_time" placeholder="{{ __('End Time') }}" value="{{ old('end_time') ?? $time->end_time }}" autocomplete="off" required />
                                    </div>
                                </div><!--form-group-->
                        ...
                        <x-slot name="footer">
                            <button class="btn btn-sm btn-primary float-right" type="submit">@lang('Update Time Record')</button>
                        </x-slot>
                    </x-frontend.card>
                </x-forms.patch>
            </div><!--col-md-10-->
