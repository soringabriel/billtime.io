...
<div class="request-body">
    ...
    <ul class="request-parameters">
        <li>
            <span class="parameter">locale</span>
            <span class="type type-string">string</span>
            <span class="validation">@lang('optional')</span>
            <span class="description">
                @lang('The language of the invoice.')
                @lang('Must be a value from this list:')
                {{ json_encode(array_keys(config('boilerplate.locale.invoices_languages'))) }}
            </span>
        </li>
    </ul>
</div>
...
<div class="test-api">
    ...
    <div class="test-api-playground">
        <input type="text" class="url form-control mb-3" value="{{ route('user.api.invoices.download', ['invoice' => 10]) }}">
        ...
        <div class="tab-content">
            <div class="tab-pane fade params show active" id="bodyUpdateInvoices" role="tabpanel" aria-labelledby="bodyUpdateInvoices-tab">
                ...
                <div class="parameter">
                        ...
                        <div class="name"><input type="text" class="form-control" placeholder="{{ __('parameter name') }}" value="locale"></div>
                        <div class="value"><input type="text" class="form-control" placeholder="{{ __('parameter value') }}" value="en"></div>
                    </div>
                </div>
            </div>
