<h2 class="endpoint-title"><span class="get-tag">GET</span> /api/invoice</h2>
...
<div class="test-api">
    ...
    <div class="test-api-playground">
        ...
        <ul class="nav nav-tabs"  role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="bodyListInvoices-tab" data-toggle="tab" href="#bodyListInvoices" role="tab" aria-controls="home" aria-selected="true">Body</a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content">
            <div class="tab-pane fade params show active" id="bodyListInvoices" role="tabpanel" aria-labelledby="bodyListInvoices-tab">
            ...
            <div class="tab-pane fade headers" id="headersListInvoices" role="tabpanel" aria-labelledby="headersListInvoices-tab">
                <div class="tab-content pt-3">
                    <div class="parameter">
