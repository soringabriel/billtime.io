...
<div class="test-api">
    ...
    <div class="test-api-playground">
        <input type="text" class="url form-control mb-3" value="{{ route('user.api.time.update', ['time' => 10]) }}">
        <input type="hidden" class="method" value="PATCH">
        <ul class="nav nav-tabs"  role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="bodyUpdateTimes-tab" data-toggle="tab" href="#bodyUpdateTimes" role="tab" aria-controls="home" aria-selected="true">Body</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="headersUpdateTimes-tab" data-toggle="tab" href="#headersUpdateTimes" role="tab" aria-controls="profile" aria-selected="false">Headers</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="codeUpdateTimes-tab" data-toggle="tab" href="#codeUpdateTimes" role="tab" aria-controls="profile" aria-selected="false">Code</a>
            </li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane fade params show active" id="bodyUpdateTimes" role="tabpanel" aria-labelledby="bodyUpdateTimes-tab">
            ...
            <div class="tab-pane fade headers" id="headersUpdateTimes" role="tabpanel" aria-labelledby="headersUpdateTimes-tab">
                <div class="tab-content pt-3">
                    <div class="parameter">
                        <div class="checkbox"><input type="checkbox" checked></div>
            ...
            <div class="tab-pane fade code" id="codeUpdateTimes" role="tabpanel" aria-labelledby="codeUpdateTimes-tab">
                <div class="tab-content pt-3">
                    <div class="tab-pane fade show active" role="tabpanel" aria-labelledby="code-sample-tab">
                        <div>
                            <div class="col-12">
                                <div class="nav nav-pills" role="tablist">
                                    <a class="nav-link tab-title active" id="updateTimes-curl" data-toggle="pill" href="#updateTimes-tab-curl" role="tab" aria-controls="updateTimes-tab-curl" aria-selected="true">
                                        @lang('Curl')
                                    </a>
                                    <a class="nav-link tab-title" id="updateTimes-nodejs" data-toggle="pill" href="#updateTimes-tab-nodejs" role="tab" aria-controls="updateTimes-tab-nodejs" aria-selected="false">
                                        @lang('NodeJS')
                                    </a>
                                    <a class="nav-link tab-title" id="updateTimes-python" data-toggle="pill" href="#updateTimes-tab-python" role="tab" aria-controls="updateTimes-tab-python" aria-selected="false">
                                        @lang('Python')
                                    </a>
                                    <a class="nav-link tab-title" id="updateTimes-php" data-toggle="pill" href="#updateTimes-tab-php" role="tab" aria-controls="updateTimes-tab-php" aria-selected="false">
                                        @lang('PHP')
                                    </a>
                                    <a class="nav-link tab-title" id="updateTimes-golang" data-toggle="pill" href="#updateTimes-tab-golang" role="tab" aria-controls="updateTimes-tab-golang" aria-selected="false">
                                        @lang('Golang')
                                    </a>
                                    <a class="nav-link tab-title" id="updateTimes-java" data-toggle="pill" href="#updateTimes-tab-java" role="tab" aria-controls="updateTimes-tab-java" aria-selected="false">
                                        @lang('Java')
                                    </a>
                                    <a class="nav-link tab-title" id="updateTimes-dotnet" data-toggle="pill" href="#updateTimes-tab-dotnet" role="tab" aria-controls="updateTimes-tab-dotnet" aria-selected="false">
                                        @lang('.NET')
                                    </a>
                                    <a class="nav-link tab-title" id="updateTimes-ruby" data-toggle="pill" href="#updateTimes-tab-ruby" role="tab" aria-controls="updateTimes-tab-ruby" aria-selected="false">
                                        @lang('Ruby')
                                    </a>
                                </div>
                            </div>
                            <div class="col-12 pt-4">
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="updateTimes-tab-curl" role="tabpanel" aria-labelledby="curl">
                                        <div>
                                            <pre class="language-curl"><code class="language-bash"></code></pre>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="updateTimes-tab-nodejs" role="tabpanel" aria-labelledby="nodejs">
                                        <div>
                                            <pre class="language-nodejs"><code class="language-javascript"></code></pre>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="updateTimes-tab-python" role="tabpanel" aria-labelledby="python">
                                        <div>
                                            <pre class="language-python"><code class="language-python"></code></pre>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="updateTimes-tab-php" role="tabpanel" aria-labelledby="php">
                                        <div>
                                            <pre class="language-php"><code class="language-php"></code></pre>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="updateTimes-tab-golang" role="tabpanel" aria-labelledby="golang">
                                        <div>
                                            <pre class="language-go"><code class="language-go"></code></pre>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="updateTimes-tab-java" role="tabpanel" aria-labelledby="java">
                                        <div>
                                            <pre class="language-java"><code class="language-java"></code></pre>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="updateTimes-tab-dotnet" role="tabpanel" aria-labelledby="dotnet">
                                        <div>
                                            <pre class="language-csharp "><code class="language-csharp"></code></pre>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="updateTimes-tab-ruby" role="tabpanel" aria-labelledby="ruby">
                                        <div>
