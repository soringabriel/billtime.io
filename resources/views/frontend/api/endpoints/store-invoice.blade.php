...
<div class="test-api">
    ...
    <div class="test-api-playground">
        <input type="text" class="url form-control mb-3" value="{{ route('user.api.invoices.store') }}">
        <input type="hidden" class="method" value="POST">
        <ul class="nav nav-tabs"  role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="bodyStoreInvoices-tab" data-toggle="tab" href="#bodyStoreInvoices" role="tab" aria-controls="home" aria-selected="true">Body</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="headersStoreInvoices-tab" data-toggle="tab" href="#headersStoreInvoices" role="tab" aria-controls="profile" aria-selected="false">Headers</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="codeStoreInvoices-tab" data-toggle="tab" href="#codeStoreInvoices" role="tab" aria-controls="profile" aria-selected="false">Code</a>
            </li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane fade params show active" id="bodyStoreInvoices" role="tabpanel" aria-labelledby="bodyStoreInvoices-tab">
            ...
            <div class="tab-pane fade headers" id="headersStoreInvoices" role="tabpanel" aria-labelledby="headersStoreInvoices-tab">
                <div class="tab-content pt-3">
                    <div class="parameter">
                        <div class="checkbox"><input type="checkbox" checked></div>
            ...
            <div class="tab-pane fade code" id="codeStoreInvoices" role="tabpanel" aria-labelledby="codeStoreInvoices-tab">
                <div class="tab-content pt-3">
                    <div class="tab-pane fade show active" role="tabpanel" aria-labelledby="code-sample-tab">
                        <div>
                            <div class="col-12">
                                <div class="nav nav-pills" role="tablist">
                                    <a class="nav-link tab-title active" id="storeInvoices-curl" data-toggle="pill" href="#storeInvoices-tab-curl" role="tab" aria-controls="storeInvoices-tab-curl" aria-selected="true">
                                        @lang('Curl')
                                    </a>
                                    <a class="nav-link tab-title" id="storeInvoices-nodejs" data-toggle="pill" href="#storeInvoices-tab-nodejs" role="tab" aria-controls="storeInvoices-tab-nodejs" aria-selected="false">
                                        @lang('NodeJS')
                                    </a>
                                    <a class="nav-link tab-title" id="storeInvoices-python" data-toggle="pill" href="#storeInvoices-tab-python" role="tab" aria-controls="storeInvoices-tab-python" aria-selected="false">
                                        @lang('Python')
                                    </a>
                                    <a class="nav-link tab-title" id="storeInvoices-php" data-toggle="pill" href="#storeInvoices-tab-php" role="tab" aria-controls="storeInvoices-tab-php" aria-selected="false">
                                        @lang('PHP')
                                    </a>
                                    <a class="nav-link tab-title" id="storeInvoices-golang" data-toggle="pill" href="#storeInvoices-tab-golang" role="tab" aria-controls="storeInvoices-tab-golang" aria-selected="false">
                                        @lang('Golang')
                                    </a>
                                    <a class="nav-link tab-title" id="storeInvoices-java" data-toggle="pill" href="#storeInvoices-tab-java" role="tab" aria-controls="storeInvoices-tab-java" aria-selected="false">
                                        @lang('Java')
                                    </a>
                                    <a class="nav-link tab-title" id="storeInvoices-dotnet" data-toggle="pill" href="#storeInvoices-tab-dotnet" role="tab" aria-controls="storeInvoices-tab-dotnet" aria-selected="false">
                                        @lang('.NET')
                                    </a>
                                    <a class="nav-link tab-title" id="storeInvoices-ruby" data-toggle="pill" href="#storeInvoices-tab-ruby" role="tab" aria-controls="storeInvoices-tab-ruby" aria-selected="false">
                                        @lang('Ruby')
                                    </a>
                                </div>
                            </div>
                            <div class="col-12 pt-4">
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="storeInvoices-tab-curl" role="tabpanel" aria-labelledby="curl">
                                        <div>
                                            <pre class="language-curl"><code class="language-bash"></code></pre>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="storeInvoices-tab-nodejs" role="tabpanel" aria-labelledby="nodejs">
                                        <div>
                                            <pre class="language-nodejs"><code class="language-javascript"></code></pre>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="storeInvoices-tab-python" role="tabpanel" aria-labelledby="python">
                                        <div>
                                            <pre class="language-python"><code class="language-python"></code></pre>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="storeInvoices-tab-php" role="tabpanel" aria-labelledby="php">
                                        <div>
                                            <pre class="language-php"><code class="language-php"></code></pre>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="storeInvoices-tab-golang" role="tabpanel" aria-labelledby="golang">
                                        <div>
                                            <pre class="language-go"><code class="language-go"></code></pre>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="storeInvoices-tab-java" role="tabpanel" aria-labelledby="java">
                                        <div>
                                            <pre class="language-java"><code class="language-java"></code></pre>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="storeInvoices-tab-dotnet" role="tabpanel" aria-labelledby="dotnet">
                                        <div>
                                            <pre class="language-csharp "><code class="language-csharp"></code></pre>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="storeInvoices-tab-ruby" role="tabpanel" aria-labelledby="ruby">
                                        <div>
