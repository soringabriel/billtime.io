...
@section('title', __('Add Schedule'))

@section('content')
    <div class="container py-4">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <x-forms.post :action="route('frontend.schedules.store')">
                    <x-frontend.card>
                        <x-slot name="header">
                            @lang('Add Schedule')
                        </x-slot>
                        ...
                        <x-slot name="body">
                            <div x-data="{price: 0, currency: 'USD'}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="number" name="schedule_trigger" class="form-control" placeholder="{{ __('Day of the month') }}" min="1" max="31" />
                                    </div>
                                </div><!--form-group-->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="number" name="price_per_hour" x-model="price" class="form-control" placeholder="{{ __('Price per hour') }}" step=".01" />
                                    </div>
                                </div><!--form-group-->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="number" name="shipping" class="form-control" min="0" placeholder="{{ __('Shipping') }}" step=".01" />
                                    </div>
                                </div><!--form-group-->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="number" name="service_fee" class="form-control" min="0" placeholder="{{ __('Service Fee') }}" step=".01" />
                                    </div>
                                </div><!--form-group-->
