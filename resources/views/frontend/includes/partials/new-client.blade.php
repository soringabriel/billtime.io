<div class="card p-3">
    ...
    <div class="form-group row">
        <label for="client_name" class="col-md-4 col-form-label">
    ...
    <div class="form-group row">
        <label for="client_company_name" class="col-md-4 col-form-label">
            @lang('Company Name')
    ...
    <div class="form-group row">
        <label for="client_tax_number" class="col-md-4 col-form-label">
            @lang('Tax Number')
    ...
    <div class="form-group row">
        <label for="client_vat_number" class="col-md-4 col-form-label">
            @lang('Vat Number')
    ...
    <div class="form-group row">
        <label for="client_address" class="col-md-4 col-form-label">
            @lang('Address')
    ...
    <div class="form-group row">
        <label for="client_bank_account" class="col-md-4 col-form-label">
            @lang('Bank Account')
