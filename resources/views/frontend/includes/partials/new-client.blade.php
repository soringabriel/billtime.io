<div class="card p-3">
    ...
    <div class="form-group row">
        <div class="col-12 d-inline-flex align-items-center">
            <label for="client_name" class="w-50 col-form-label">
    ...
    <div class="form-group row">
        <div class="col-12 d-inline-flex align-items-center">
            <label for="client_company_name" class="w-50 col-form-label">
                @lang('Company Name')
    ...
    <div class="form-group row">
        <div class="col-12 d-inline-flex align-items-center">
            <label for="client_tax_number" class="w-50 col-form-label">
                @lang('Tax Number')
    ...
    <div class="form-group row">
        <div class="col-12 d-inline-flex align-items-center">
            <label for="client_vat_number" class="w-50 col-form-label">
                @lang('Vat Number')
    ...
    <div class="form-group row">
        <div class="col-12 d-inline-flex align-items-center">
            <label for="client_address" class="w-50 col-form-label">
                @lang('Address')
    ...
    <div class="form-group row">
        <div class="col-12 d-inline-flex align-items-center">
            <label for="client_bank_account" class="w-50 col-form-label">
                @lang('Bank Account')
