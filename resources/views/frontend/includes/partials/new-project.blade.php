<div class="card p-3">
    ...
    <div class="form-group row">
        <div class="col-12 d-inline-flex align-items-center">
            <label for="project_name" class="col-form-label w-50">
    ...
    <template x-if="new_project">
        <div class="form-group row" x-data="{new_client: false}">
            <div :class="new_client ? 'col-12 d-inline-flex align-items-center' : 'col-12 d-inline-flex align-items-top'">
                <label for="project_client_id" class="col-form-label w-50">
            ...
            <div class="w-100 mt-2 pl-2 pr-2" x-show="new_client">
