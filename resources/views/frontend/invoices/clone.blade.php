...
@section('title', __('Duplicate Invoice'))
...
@section('content')
                                        ...
                                        <div class="form-group row invoice-row">
                                            ...
                                            <div class="col-md-6" x-data="initBuyer()">
                                                ...
                                                <div class="field-group field-group-required">
                                                    ...
                                                    <input id="buyerCompanyName" x-model="buyerCompanyName" type="text" name="buyer_company_name" value="{{ old('buyer_company_name') ?? $invoice->buyer_company_name }}" class="form-control" placeholder="{{ __('Buyer Name') }}" maxlength="255" required />
                                                </div>
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <input id="buyerTaxNumber" x-model="buyerTaxNumber" type="text" name="buyer_tax_number" value="{{ old('buyer_tax_number') ?? $invoice->buyer_tax_numbe }}" class="form-control" placeholder="{{ __('Tax Number') }}" maxlength="255" />
                                                </div>
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <input id="buyerVatNumber" x-model="buyerVatNumber" type="text" name="buyer_vat_number" value="{{ old('buyer_vat_number') ?? $invoice->buyer_vat_number }}" class="form-control" placeholder="{{ __('Vat Number') }}" maxlength="255" />
                                                </div>
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <input id="buyerAddress" x-model="buyerAddress" type="text" name="buyer_address" value="{{ old('buyer_address') ?? $invoice->buyer_address }}" class="form-control" placeholder="{{ __('Address') }}" maxlength="255" />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade pt-3 show" id="times" role="tabpanel" aria-labelledby="times-tab">
                                    <div class="form-group">
                                        ...
                                        <livewire:frontend.time-table 
                                            ...
                                            bulk="1"
                                            exports="0"
                                            preCheckedValues="{{ old('times') ? json_encode(old('times')) : json_encode($invoice->times()->pluck('id')->toArray()) }}"
                                         />
                                    </div>
                                </div><!--tab-times-->
                            </div>
    ...
    <script>
        function initBuyer() {
            return {
                buyerClient: [],
                buyerCompanyName: "{{ old('buyer_company_name') ?? $invoice->buyer_company_name }}",
                buyerTaxNumber: "{{ old('buyerTaxNumber') ?? $invoice->buyerTaxNumber }}",
                buyerVatNumber: "{{ old('buyerVatNumber') ?? $invoice->buyerVatNumber }}",
                buyerAddress: "{{ old('buyerAddress') ?? $invoice->buyerAddress }}",
                updateBuyer() {
